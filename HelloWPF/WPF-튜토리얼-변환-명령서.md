...
루트 `ch*` 34개 프로젝트 전부 변환 완료입니다. "연습 블록"은 직접 해보기 개수입니다.
...
| ch23 메뉴 | 5 | 10 | 완료 |
| ch24 컨텍스트메뉴 | 5 | 10 | 완료 |
| ch25 데이터바인딩1 | 5 | 10 | 완료 |
| ch26 데이터바인딩2 | 5 | 10 | 완료 |
| ch27 데이터바인딩3 | 5 | 10 | 완료 |
| ch28 영어단어맞추기 | 4 | 8 | 완료 |
| ch29 화면이동 프레임 | 4 | 8 | 완료 |
| ch30 탭컨트롤 모달 모달리스 | 4 | 8 | 완료 |
| ch31 유저컨트롤 | 5 | 10 | 완료 |
| ch32 스타일 | 5 | 10 | 완료 |
| ch33 애니메이션 | 5 | 10 | 완료 |
| ch34 MVVM | 5 | 10 | 완료 |
| ch35 MariaDB연동 | 5 | 10 | 완료 |
