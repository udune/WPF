...
namespace ch10_캘린더
{
    public partial class MainWindow : Window
    {
        ...
        private readonly Dictionary<string, string> _answers = new()
        {
            ...
            { "1_3", "<Calendar SelectedDate=\"2025-12-25\"/>" },

            // 탭 2: 날짜 범위 제한
            { "2_1", "<Calendar DisplayDateStart=\"2025-03-01\" DisplayDateEnd=\"2025-03-31\"/>" },
            { "2_2", "private void DisablePastDates()\n{\n    calendarControl.BlackoutDates.AddDatesInPast();\n}" },

            // 탭 3: 선택 모드와 이벤트
            { "3_1", "<Calendar SelectionMode=\"MultipleRange\"/>" },
            { "3_2", "private void Calendar_SelectedDatesChanged(object sender, SelectionChangedEventArgs e)\n{\n    if (myCalendar.SelectedDate.HasValue)\n    {\n        txtResult.Text = myCalendar.SelectedDate.Value.ToString(\"yyyy-MM-dd\");\n    }\n}" },

            // 탭 4: 데이터 바인딩
            { "4_1", "<Calendar IsTodayHighlighted=\"False\"/>" },

            // 탭 5: 스타일과 코드비하인드
            { "5_1", "<Calendar Background=\"LightBlue\" BorderBrush=\"Navy\"/>" },
            { "5_2", "<Calendar FirstDayOfWeek=\"Monday\"/>" },
